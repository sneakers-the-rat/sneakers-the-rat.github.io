...
Say, to a crude approximation, scientists are workers who produce "knowledge." Backing hastily away from our scare quotes, we might say instead, at least for systems neuroscientists, it might be less controversial to say that we are workers who produce and interpret data. 

Where is it? Literally where is your data? What format is it in? How did you collect it? What would you have to do to share it with someone?
